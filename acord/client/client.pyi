...
from acord import (
    User, Presence, Snowflake, Stage, StagePrivacyLevel,
    Guild
)
...
class Client(object):
    ...
    @overload
    async def wait_for(self, event: str, *, check: Callable[..., bool]) -> Tuple[Any]: ...

    @overload
    def wait_for(self, event: str, *, check: Callable[..., bool], timeout: int) -> _C: ...

    @overload
    async def wait_for(self, event: str, *, check: Callable[..., bool], timeout: int) -> Tuple[Any]: ...
    ...
    @overload
    async def check_presence(self, presence: Presence) -> None: ...
