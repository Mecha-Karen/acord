...
def setup(app):
    ...
    app.add_node(
        AttrTableColumn, html=(visit_AttrTableColumn_node, depart_AttrTableColumn_node)
    )
    app.add_node(
        AttrTableTitle, html=(visit_AttrTableTitle_node, depart_AttrTableTitle_node)
    )
    app.add_node(
        AttrTableBadge, html=(visit_AttrTableBadge_node, depart_AttrTableBadge_node)
    )
    app.add_node(
        AttrTableItem, html=(visit_AttrTableItem_node, depart_AttrTableItem_node)
    )
